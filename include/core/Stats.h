...
struct Stats
{
    ...
    void increaseMaxHpPercent(int amount);
    void increaseMaxManaPercent(int amount);
    void increaseAtkPercent(int amount);
    void increaseDefPercent(int amount);
    void increaseSpdPercent(int amount);
    void increaseIntlPercent(int amount);    
